...
Format des Textfiles: Erste Zeile bestimmte die Anzahl der Matrix d.h. bei der Angabe 4 werden 4*4 Adjazenmatrix erstellt, ab der zweiten werden die Einträge in einer tabelle geordnet, Einträge sind mit einem Leezeichen voneinander getrennt.
